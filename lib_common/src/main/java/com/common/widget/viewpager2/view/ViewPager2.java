...
import com.common.R;
import com.common.widget.viewpager2.adapter.StatefulAdapter;
...
/**
 * ViewPager2 replaces {@link android.support.v4.view.ViewPager}, addressing most of its
...
public final class ViewPager2 extends ViewGroup {
    ...
    private void setOrientation(Context context, AttributeSet attrs) {
        ...
        try {
            setOrientation(a.getInt(R.styleable.ViewPager2_android_orientation, ORIENTATION_HORIZONTAL));
        } finally {
            a.recycle();
        }
    }
    ...
    /**
     * @see com.common.widget.viewpager2.adapter.FragmentStateAdapter
